...
const About = ({ handleClick }) => {
   ...
   <div className="hero">
   <span className="h4">We are creating a new wave in remote hiring by helping companies hire from a strong network of top talents from India, for the world.</span>
   </div>    
